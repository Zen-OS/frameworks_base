...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener {
		...
		final int temperature = intent.getIntExtra(EXTRA_TEMPERATURE, -1);;
                final Message msg = mHandler.obtainMessage(
                        MSG_BATTERY_UPDATE, new BatteryStatus(status, level, plugged, health,
                                 maxChargingMicroAmp, maxChargingMicroVolt, maxChargingMicroWatt, temperature));
    ...
    public static class BatteryStatus {
        ...
        public BatteryStatus(int status, int level, int plugged, int health,
                int maxChargingCurrent, int maxChargingVoltage, int maxChargingWattage, int temperature) {
            this.status = status;
            this.level = level;
